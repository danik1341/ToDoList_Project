...
<NavigationMenu className="w-screen bg-neutral-900 shadow-xl h-12 grid grid-cols-[1fr_120px] md:h-16 md:grid-cols-[1fr_180px]">
  <NavigationMenuList className="flex h-full items-center max-h-12 md:max-h-16 flex-grow">
    <NavigationMenuItem className=" flex-grow flex-row flex-nowrap items-center">
      <Button className="w-1/8 bg-neutral-800 text-white rounded py-1 px-1 m-1 text-[10px] md:text-sm">sometext</Button>
      <Button className=" bg-neutral-800 text-white rounded py-1 px-1 m-1 text-md">+</Button>
    </NavigationMenuItem>
  </NavigationMenuList>
  <NavigationMenuList className="">
    <NavigationMenuItem className="">
      <NavigationMenuTrigger className="">
        <Button  className="flex justify-between items-center rounded-md bg-neutral-800 text-white  h-12 md:h-16 p-1 w-full ">
